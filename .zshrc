...
export MOZ_ENABLE_WAYLAND=1 # firefox and wayland are friends...
export QT_QPA_PLATFORM=xcb # keepassXC and wayland are friends
export PATH=$PATH:$HOME/bin/:$HOME/.cargo/bin

# FZF CONFIGURATION 
# Tokyonight night theme fzf 
...
plugins=(git fzf-tab zsh-autosuggestions sudo colorize fzf)
...
alias fzf-preview="$HOME/.fzf/bin/fzf-preview.sh"

alias config="git --git-dir=$HOME/.dotfiles --work-tree=$HOME" # to manage the dotfiles
...
# source https://gist.github.com/mehalter/2809925b6e266b3574c7deab3dae711a
